...
describe('calculator functionality', function() {
  ...
  it('should be able to divide and display a decimal number', function(){
    running_total = element(by.css('#running_total'));
  ...
  it('should be able to show when the result of the operation is negative', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number1')).click();
  ...
  it('should be able to show when the result of the operation is large', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number2')).click();
    ...
    element(by.css('#number2')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('12591283236');
  })
